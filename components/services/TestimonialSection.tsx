// Shared "What Our Client Say About Us" testimonials section, ported from
// frontend.includes.partials.testimonial (Blade) and included on the
// aidevelopement / laravel / maintenanceservices service pages.
