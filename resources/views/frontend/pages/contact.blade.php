            ...
            <div class="contact-grid">
                ...
                <div class="office-box">
                    <div class="office-card">
                        <h4><img class="me-1" width="24" src="{{asset('assets/images/Group-4.webp')}}" alt="us-flag"
                                class="site-country-flag" loading="lazy"> US </h4>
                        <p>1601 Penfield Road Suite <br>575 Rochester, NY 14625</p>
                        <strong>+1 (646) 568-7779</strong>
                    </div>

                    <div class="office-card">
                        <h4><img class="me-1" width="24" src="{{asset('assets/images/canada.jpg')}}" alt="us-flag"
                                class="site-country-flag" loading="lazy"> Canada </h4>
                        <p>2482 Yonge Street #1080 Toronto,<br> ON M4P 2H5 Canada</p>
                        <strong>+1 (646) 568-7779</strong>
                    </div>

                    <div class="office-card">
                        <h4><img class="me-1" width="24" src="{{asset('assets/images/Group-3.webp')}}" alt="us-flag"
                ...
                <div class="testimonial" style="background-image:url({{asset('assets/images/thumbs/video.png')}});">
                    ...
                    <div class="video-box">
                        <div class="position-relative max-w-390-px w-100">
                            <img src="{{asset('assets/images/thumbs/service-details-video-img.jpg')}}" alt="Thumb"
                    ...
                    <div class="testimonial-content">
                        ...
                        <div class="clint-relation"><span class="fw-bold">Long Term Client</span> | 5+ Years
                            Collaboration</div>
                    </div>
                </div>
