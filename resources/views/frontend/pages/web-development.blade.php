                ...
                <div class="banner-two__inner position-relative">
                    <div class="container">
                        <div class="text-center">
                            <span class="text-capitalize font-caveat fw-bold tw-mb-6 h3">Custom Web Development </span>
                            <div class="">
                            ...
                            <p
                               ...
                               and responsive websites that 
                               help businesses build trust, 
                               engage users, and grow online—globally.
                            </p>
                                        ...
                                        <div class="swiper-wrapper transition-timing-linear tw-gap-6">
                                            <div class="swiper-slide">
                                                <div class="tw-rounded-2xl overflow-hidden">
                                                    <img src="{{asset('assets/images/thumbs/wb1.png')}}" alt="Image"
                                                        class="w-100 h-100 object-fit-cover" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="tw-rounded-2xl overflow-hidden">
                                                    <img src="{{asset('assets/images/thumbs/wb2.png')}}" alt="Image"
                                                        class="w-100 h-100 object-fit-cover" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="tw-rounded-2xl overflow-hidden">
                                                    <img src="{{asset('assets/images/thumbs/wb3.png')}}" alt="Image"
                                                        class="w-100 h-100 object-fit-cover" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="tw-rounded-2xl overflow-hidden">
                                                    <img src="{{asset('assets/images/thumbs/wb4.png')}}" alt="Image"
                                                        class="w-100 h-100 object-fit-cover" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="tw-rounded-2xl overflow-hidden">
                                                    <img src="{{asset('assets/images/thumbs/wb5.png')}}" alt="Image"
                                                        class="w-100 h-100 object-fit-cover" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                        ...
                        <div class="col-lg-7 ps-lg-5">
                            <div class="">
                                <div class="bg-neutral-100 tw-py-3 tw-px-305 rounded-pill text-heading fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max"
                                    ...
                                    Up to <span class="text-yellow">3x</span> Faster Load Times & Better User Engagement
                                </div>
                                <h2 class="splitTextStyleOne text-heading text-capitalize">
                                   Our Web Development Services 
                                    <span class="font-dm-serif fst-italic fw-normal">Built for Performance,</span>
                                    Security & Growth
                                </h2>
                                <p class="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                                 ...
                                 web applications designed to handle 
                                 growing traffic, complex workflows, and 
                                 evolving business needs—without compromising on speed or security.
                                </p>
                ...
                <div class="container max-w-1400-px">
                    <div class="max-w-672-px text-center mx-auto tw-mb-12">
                        ...
                        <p class="text-neutral-500 tw-mt-5 splitTextStyleOne max-w-500-px mx-auto">
                            We bring together design, development, and modern technologies to deliver smooth, scalable, 
                            and conversion-focused web solutions—ensuring your website performs flawlessly at every stage of growth.
                        </p>
                    </div>
                        ...
                        <div class="row col-border-wrapper">
                            <div class="col-xl-3 col-md-4 col-sm-6 col-xs-6 border-0">
                                <div class="bg-white tw-py-12 tw-px-6 text-center hover-common-shadow-sixteen tw-rounded-2xl">
                                    ...
                                    <p class="mx-auto max-w-228-px text-neutral-500 tw-text-sm tw-mb-705">
                                       We design and develop tailor-made websites 
                                       and web applications based on your business 
                                       objectives—ensuring flexibility, performance, and long-term scalability.
                                    </p>
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-xs-6 border-0">
                                <div class="bg-white tw-py-12 tw-px-6 text-center hover-common-shadow-sixteen tw-rounded-2xl">
                                    ...
                                    <p class="mx-auto max-w-228-px text-neutral-500 tw-text-sm tw-mb-705">
                                        We build secure, high-performance APIs that 
                                        enable seamless communication between 
                                        front-end, backend, and third-party systems.
                                    </p>
                                    <a href="{{route('intigration.details')}}"
                                        class="fw-semibold text-main-600 d-inline-flex align-items-center tw-gap-3 hover-underline">
                                        View API Services
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 col-xs-6 border-0">
                                <div class="bg-white tw-py-12 tw-px-6 text-center hover-common-shadow-sixteen tw-rounded-2xl">
                                    ...
                                    <p class="mx-auto max-w-228-px text-neutral-500 tw-text-sm tw-mb-705">
                                        ...
                                        support to keep your website fast, 
                    ...
                    <div class="row gy-5 align-items-center flex-wrap-reverse">
                        <div class="col-xl-6" data-aos="zoom-in" data-aos-anchor-placement="top-bottom"
                            ...
                            <div class="position-relative tw-p-12 text-center">
                                ...
                                <img src="{{asset('assets/images/shapes/web-development2.png')}}" alt="Icons"
                                    class="position-absolute top-50 start-50 animation-rotate-right" />
                                <img src="{{asset('assets/images/shapes/web-development.png')}}" alt="Icons"
                                ...
                                <div class="text-start mx-auto tw-mb-12">
                                    <div class="tw-mb-10">
                                        ...
                                        <p
                                            ...
                                            We build high-performance websites that are fast, 
                                            responsive, and future-ready. 
                                            Our web development solutions focus on clean 
                                            architecture, optimized performance, and strong 
                                            security—ensuring smooth user experiences 
                                            even with growing traffic and business demands.
                                        </p>
                                    </div>
                                    <div class="tw-mt-9" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                                        ...
                                        <a href="{{route('pricing')}}"
                                            ...
                                            data-block="button">
                                            <span class="button__flair"></span>
                                            <span class="button__label">Get a Free Web Consultation</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="max-w-672-px text-center mx-auto tw-mb-12">
                        ...
                        <h2 class="splitTextStyleOne text-white">
                            ...
                            <span class="font-dm-serif fst-italic fw-normal">
                                With Expert </span>Web Development
                        </h2>
                        <p class="text-neutral-300 tw-mt-5 splitTextStyleOne max-w-570-px mx-auto">
                           Our web development solutions are built for speed, scalability, 
                           and security—helping businesses create impactful digital experiences that drive engagement and growth.
                        </p>
                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <p
                                                ...
                                                We build fast, responsive, and optimized 
                                                websites designed to deliver smooth user 
                                                experiences, high conversions, and reliable 
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <p
                                                class="text-neutral-300 tw-mt-3 line-clamp-2 d-none group-hover-item-d-block">
                                                Our skilled developers bring deep 
                                                expertise in modern frameworks, 
                                                UI/UX best practices, and backend 
                                                systems to deliver reliable and future-ready web solutions.
                                            </p>
                                            <a href="javascript:void(0)"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <p
                                                class="text-neutral-300 tw-mt-3 line-clamp-2 d-none group-hover-item-d-block">
                                               We design scalable web architectures 
                                               that grow with your business—handling 
                                               increasing traffic, content, and 
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <p
                                                class="text-neutral-300 tw-mt-3 line-clamp-2 d-none group-hover-item-d-block">
                                                We follow industry-standard security 
                                                practices to protect your website from 
                                                vulnerabilities, ensure data safety, and maintain long-term stability.
                                            </p>
                                            <a href="javascript:void(0)"
                                                class="d-flex align-items-center tw-gap-205 text-main-600 fw-bold d-lg-flex align-items-center tw-gap-305 group-hover-text-white tw-duration-200 tw-mt-6 tw-transition-0">
                                                Learn More
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <p
                                                class="text-neutral-300 tw-mt-3 line-clamp-2 d-none group-hover-item-d-block">
                                              We integrate your website with third-party tools, CRMs, payment gateways, 
                                              analytics platforms, and marketing systems to ensure smooth data flow and better operational efficiency.
                                            </p>
                                            <a href="javascript:void(0)"
                                                class="d-flex align-items-center tw-gap-205 text-main-600 fw-bold d-lg-flex align-items-center tw-gap-305 group-hover-text-white tw-duration-200 tw-mt-6 tw-transition-0">
                                                Learn More
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <p
                                                class="text-neutral-300 tw-mt-3 line-clamp-2 d-none group-hover-item-d-block">
                                                We follow an agile web development approach with clear 
                                                communication, regular updates, and milestone-based 
                                                delivery—so you stay informed at every stage of the project.
                                            </p>
                                            <a href="javascript:void(0)"
                                                class="d-flex align-items-center tw-gap-205 text-main-600 fw-bold d-lg-flex align-items-center tw-gap-305 group-hover-text-white tw-duration-200 tw-mt-6 tw-transition-0">
                                                Learn More
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <p
                                                class="text-neutral-300 tw-mt-3 line-clamp-2 d-none group-hover-item-d-block">
                                               Get high-quality web development services at 
                                               competitive pricing without compromising on performance, 
                                               security, or design—ideal for startups, SMEs, and international clients.
                                            </p>
                                            <a href="javascript:void(0)"
                                                class="d-flex align-items-center tw-gap-205 text-main-600 fw-bold d-lg-flex align-items-center tw-gap-305 group-hover-text-white tw-duration-200 tw-mt-6 tw-transition-0">
                                                Learn More
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="">
                                            ...
                                            <p
                                                class="text-neutral-300 tw-mt-3 line-clamp-2 d-none group-hover-item-d-block">
                                                We provide continuous website support, updates, 
                                                security patches, and performance monitoring to 
                                                keep your web platform stable, secure, and up to date.
                                            </p>
                                            <a href="javascript:void(0)"
                                                class="d-flex align-items-center tw-gap-205 text-main-600 fw-bold d-lg-flex align-items-center tw-gap-305 group-hover-text-white tw-duration-200 tw-mt-6 tw-transition-0">
                                                Learn More
                                     ...
                                     <div class="accordion-item tw-py-8 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0"
                                        ...
                                        <h5
                                            ...
                                            <button
                                                ...
                                                ❓ Do you build custom and responsive websites?
                                            </button>
                                        </h5>
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body p-0 tw-mt-605 max-w-620-px">
                                                <p class="text-neutral-500">
                                                   Yes. We create fully custom, mobile-responsive, 
                                                   and fast-loading websites tailored to your business goals and brand identity.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="accordion-item tw-py-8 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0"
                                        ...
                                        <h5
                                            ...
                                            <button
                                                ...
                                                data-bs-target="#collapseThree" aria-expanded="false"
                                                aria-controls="collapseThree">
                                                ❓ Will my website be SEO-friendly and optimized?
                                            </button>
                                        </h5>
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body p-0 tw-mt-605 max-w-620-px">
                                                <p class="text-neutral-500">
                                                   Definitely. All our websites are built 
                                                   with clean code, SEO best practices, 
                            ...
                            <div class="d-block">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <span class="button__label"
                                                >Start Your Web Development Project</span
                                            >
                                        </div>
                                    </a>
                                    <a
