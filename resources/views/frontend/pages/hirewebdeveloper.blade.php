                    ...
                    <div class="col-lg-6">
                        <div class="banner-three-content max-w-570-px">
                            <h1 class="splitTextStyleOne text-white text-capitalize tw-leading-none">
                                Hire Dedicated  
                                <span class="text-gradient-teal font-dm-serif fst-italic fw-normal">Web Developers</span>
                                For High-Performance Websites
                            </h1>
                            <p class="splitTextStyleOne text-white tw-text-lg tw-mt-8">Build-<span
                                    class="text-yellow"> fast, responsive, </span> and secure websites with our experienced web developers. 
                                    Hire skilled professionals for full-time, part-time, or project-based web development — globally.
</p>
                ...
                <div class="row gy-4 flex-wrap-reverse">
                    ...
                    <div class="col-lg-7 ps-lg-5">
                        <div class="">
                            ...
                            <p class="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                                In today’s digital-first world, businesses need fast, responsive, 
                                and scalable websites to stay competitive. 
                                Our web developers build high-performance solutions tailored to your business goals.
                            </p>
                ...
                <div class="position-relative distraction__inner">
                    ...
                    <div
                        ...
                        <h2 class="splitTextStyleOne text-heading text-capitalize text-capitalize">
                            Web  
                            <span class="font-dm-serif fst-italic fw-normal text-gradient-teal">That Works </span>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-lg-5">
                            ...
                            Hire skilled web developers to build fast, secure, and 
                            scalable websites and web applications tailored to your business needs.
                        </p>
                        <div class="accordion common-accordion accordion-border-left" id="accordionExample">
                            <div class="accordion-item tw-py-4 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0"
                                ...
                                <div id="collapseTwo12" class="accordion-collapse collapse show"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body p-0">
                                        <p class="text-neutral-500">
                                        Modern, responsive, and high-performance websites built by expert web developers.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item tw-py-4 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0"
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body p-0">
                                        <p class="text-neutral-500">
                                           Secure, scalable, and feature-rich web applications tailored to business needs.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item tw-py-4 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0"
                                ...
                                <div id="collapseOne2" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body p-0">
                                        <p class="text-neutral-500">
                                       Hire dedicated web developers for continuous development and support.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item tw-py-4 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0"
                                ...
                                <div id="collapseOne1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body p-0">
                                        <p class="text-neutral-500">
                                            Enhance performance, security, and features of existing web platforms.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item tw-py-4 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0"
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body p-0">
                                        <p class="text-neutral-500">
                                                Enterprise-grade web solutions with advanced integrations and scalability.
                                        </p>
                                    </div>
                                </div>
                            </div>
