...
const thumbSlider = ["AI1", "AI2", "AI3", "AI4", "AI5", "AI6", "AI1", "AI2", "AI3"];
...
const seamlessBoxes = [
  {
    ...
    desc: "We design and build AI solutions tailored to your business needs, ensuring accuracy, scalability, and real-world impact.",
  },
  {
    icon: "API-development.png",
    title: "AI & ML APIs",
    desc: "Secure, high-performance AI APIs that enable smooth communication between applications and intelligent systems.",
  },
  {
    icon: "Third-party-integrations.png",
    title: "Third-Party AI Integrations",
    desc: "We integrate AI tools, cloud services, and data sources to automate workflows and improve decision-making.",
  },
  {
    icon: "Maintenance-support.png",
    title: "Maintenance & support",
    desc: "Continuous monitoring, optimization, and support to keep your AI systems reliable and future-ready.",
  },
];
...
const whyChooseUs = [
  {
    ...
    title: "High-Performance AI Development",
    desc: "We build fast and efficient AI solutions optimized for accuracy, scalability, and real-time performance.",
  },
  {
    icon: "Experienced-Nodejs-Team.png",
    badge: "Dedicated Professionals",
    title: "Experienced AI Team",
    desc: "Skilled AI engineers delivering reliable, production-ready intelligent systems.",
  },
  {
    icon: "Scalable-Architecture.png",
    badge: "Scalable Systems",
    title: "Scalable AI Architecture",
    desc: "Future-ready AI architectures designed to grow with your business needs.",
  },
  {
    icon: "Secure-Backend-Solutions.png",
    badge: "Advanced Protection",
    title: "Secure AI Solutions",
    desc: "Robust and secure AI systems ensuring data protection and compliance.",
  },
  {
    icon: "API-Integration-Expertise.png",
    badge: "System Connectivity",
    title: "API & AI Integration Expertise",
    desc: "From AI APIs to third-party integrations, we ensure smooth, secure, and reliable intelligent system communication.",
  },
  {
    icon: "Agile-Transparent-Process.png",
    badge: "Agile Methodology",
    title: "Agile & Transparent Process",
    desc: "Clear workflows, regular updates, and flexible AI development aligned with your business goals.",
  },
  {
    icon: "Cost-Effective-for-USA-Market.png",
    badge: "Value-Driven Pricing",
    title: "Cost-Effective for Global Market",
    desc: "High-quality AI solutions at optimized costs without compromising performance or security.",
  },
  {
    icon: "Ongoing-Support-Maintenance.png",
    badge: "Long-Term Partnership",
    title: "Ongoing AI Support & Maintenance",
    desc: "Continuous monitoring, model optimization, and support to keep your AI systems running flawlessly.",
    learnMore: true,
  },
];
...
const faqItems = [
  ...
  {
    question: "What type of AI solutions do you develop?",
    answer:
...
const dragTags = [
  { label: "AI Integrations", bg: "gradient-bg-six", text: "text-white" },
  { label: "Cloud & AI Deployment", bg: "bg-paste", text: "text-heading" },
  { label: "Real-Time AI Systems", bg: "gradient-bg-six", text: "text-heading" },
  { label: "Machine Learning", bg: "bg-yellow", text: "text-heading" },
  { label: "NLP Solutions", bg: "bg-orange", text: "text-heading" },
  { label: "Computer Vision", bg: "gradient-bg-six", text: "text-heading" },
  { label: "LLM Integration", bg: "bg-orange", text: "text-heading" },
  { label: "REST & GraphQL APIs", bg: "gradient-bg-six", text: "text-heading" },
  { label: "Model Optimization", bg: "bg-paste", text: "text-heading" },
            ...
            <div className="col-lg-7 ps-lg-5">
              <div>
                <div className="bg-neutral-100 tw-py-3 tw-px-305 rounded-pill text-heading fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max">
                  ...
                  Up to <span className="text-yellow">90%</span> Smart, Scalable &amp; Secure AI Solutions
                </div>
                <h2 className="splitTextStyleOne text-heading text-capitalize">
                  Our AI Development Solutions
                  <span className="font-dm-serif fst-italic fw-normal"> Power Intelligent</span> Digital Products
                </h2>
                <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                  We build smart, scalable, and secure AI solutions designed to automate processes, analyze data, and
                  deliver real-time insights. Our AI systems help businesses make faster decisions, reduce costs, and
        ...
        <div className="container max-w-1400-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <p className="text-neutral-500 tw-mt-5 splitTextStyleOne max-w-500-px mx-auto">
              We connect AI models, data pipelines, and platforms into a unified ecosystem for smarter, faster, and
              scalable outcomes.
            </p>
          </div>
          ...
          <div className="row gy-5 align-items-center flex-wrap-reverse">
            <div className="col-xl-6">
              <div className="position-relative tw-p-12 text-center">
                ...
                <img
                  src="/assets/images/shapes/ai-development2.png"
                  alt="Icons"
                  className="position-absolute top-50 start-50 animation-rotate-right"
                />
                <img
                  src="/assets/images/shapes/ai-development.png"
                  alt="Icons"
              ...
              <div className="text-start mx-auto tw-mb-12">
                <div className="tw-mb-10">
                  ...
                  <h2 className="splitTextStyleOne text-heading text-capitalize max-w-532-px">
                    Fast, Scalable &amp; Secure AI Development Solutions
                  </h2>
                  <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                    We build high-performance AI solutions that are intelligent, scalable, and future-ready. Our
                    experts develop real-time, data-driven, and automation-focused AI systems designed to deliver
                    accurate insights and handle complex workloads with ease.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container max-w-1552-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <h2 className="splitTextStyleOne text-white">
              ...
              <span className="font-dm-serif fst-italic fw-normal"> with AI</span>. Expertise
            </h2>
            <p className="text-neutral-300 tw-mt-5 splitTextStyleOne max-w-570-px mx-auto">
              Our AI solutions are built for speed, scalability, and security—delivering intelligent performance for
          ...
          <div className="bg-green-deep tw-rounded-3xl tw-pt-100-px position-relative z-1">
            ...
            <div className="tw-mb-8 text-center max-w-570-px mx-auto">
              <div className="tw-py-3 tw-px-305 rounded-pill fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max text-white bg-white-13">
                <div>Build Fast &amp; Scalable AI Solutions</div>
              </div>
              <h3 className="splitTextStyleOne text-white">
                Ready to Build Powerful AI Solutions for Your Business?
              </h3>
                ...
                <div className="d-flex align-items-center tw-gap-4 justify-content-center flex-wrap">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center tw-gap-2 z-1">
                      <span className="button__label">Start Your AI Project</span>
                    </div>
                  </Link>
                  <a
                    href="https://calendly.com/zalgoinfotec/30min"
