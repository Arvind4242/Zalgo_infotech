...
// NOTE: The Laravel source (dobramoc.blade.php) contains unedited BIOAGE
...
// page's Dobramoc card describes a WooCommerce store, but this detail page
// was never customized). Ported as-is for fidelity with the live site.
...
export default function DobramocPage() {
  return (
    <PageShell>
      <CaseStudyTemplate
        heroHeading={
        ...
        heroImage={{ src: "/assets/images/thumbs/Dobramoc.jpg", alt: "Dobramoc" }}
        metaItems={[
