...
// NOTE: The Laravel source (towelsoutlet.blade.php) contains unedited BIOAGE
// placeholder copy — same headline, body text and images as bioage.blade.php.
// This appears to be a copy/paste leftover in the original site (the index
// page's Towels Outlet card describes a textile WooCommerce store, but this
// detail page was never customized). Ported as-is for fidelity with the live site.
export const metadata = buildMetadata({
  title: "Towels Outlet Case Study - Textile WooCommerce Store",
  description:
    "How Zalgo Infotech scaled Towels Outlet, a textile WooCommerce brand, with performance optimization, security, SEO, and digital marketing management.",
  keywords: [
    "Towels Outlet case study",
    "textile e-commerce case study",
...
export default function TowelsOutletPage() {
  return (
    <PageShell>
      <CaseStudyTemplate
        heroHeading={
        ...
        heroImage={{ src: "/assets/images/thumbs/towelsoutlet.jpg", alt: "Towels Outlet" }}
        metaItems={[
