...
const aboutThumbs = [
  ...
  "/assets/images/thumbs/about-slide-img2.png",
  "/assets/images/thumbs/about-slide-img3.png",
  "/assets/images/thumbs/about-slide-img1.png",
  "/assets/images/thumbs/about-slide-img2.png",
  "/assets/images/thumbs/about-slide-img3.png",
  "/assets/images/thumbs/about-slide-img1.png",
...
const seamlessCards = [
  {
    ...
    desc: "We design and develop custom Shopify stores tailored to your business needs, ensuring flexibility, performance, and a conversion-focused shopping experience.",
  },
  {
    icon: "/assets/images/icons/API-development.png",
    title: "Shopify API Development",
    desc: "We build secure, high-performance Shopify APIs that enable seamless communication between your store, apps, and third-party services.",
  },
  {
    icon: "/assets/images/icons/Third-party-integrations.png",
    title: "Third-party integrations",
    desc: "We integrate payment gateways, CRMs, ERPs, shipping tools, analytics, and marketing platforms to streamline workflows and boost efficiency.",
  },
  {
    icon: "/assets/images/icons/Maintenance-support.png",
    title: "Maintenance & support",
    desc: "We provide ongoing monitoring, updates, performance optimization, and technical support to keep your Shopify store secure, fast, and running smoothly.",
  },
];
...
const whyChooseCards = [
  {
    ...
    title: "High-Performance Shopify Development",
    desc: "We build fast, reliable, and conversion-optimized Shopify stores tailored to your business goals—ensuring seamless shopping experiences across all devices.",
  },
  {
    icon: "/assets/images/icons/Experienced-Nodejs-Team.png",
    tag: "Proven Industry Experience",
    title: "Experienced Shopify Experts",
    desc: "Our skilled Shopify developers specialize in custom themes, app integrations, and advanced store functionality to deliver results-driven eCommerce solutions.",
  },
  {
    icon: "/assets/images/icons/Scalable-Architecture.png",
    tag: "Built for Growth",
    title: "Scalable & Flexible Architecture",
    desc: "We design Shopify stores that grow with your business—supporting high traffic, complex product catalogs, and seamless third-party integrations.",
  },
  {
    icon: "/assets/images/icons/Secure-Backend-Solutions.png",
    tag: "Advanced Protection",
    title: "Secure & Reliable eCommerce Solutions",
    desc: "From secure payment gateways to data protection and compliance, we ensure your Shopify store is safe, stable, and built for long-term success.",
  },
  {
    icon: "/assets/images/icons/API-Integration-Expertise.png",
    tag: "Custom API Solutions",
    title: "API & Integration Expertise",
    desc: "We integrate third-party apps, payment gateways, shipping tools, CRMs, and custom APIs to extend your Shopify store's functionality and streamline operations.",
  },
  {
    icon: "/assets/images/icons/Agile-Transparent-Process.png",
    tag: "Transparent Workflow",
    title: "Agile & Transparent Process",
    desc: "Our development process is fully transparent and agile—keeping you informed at every stage with regular updates, clear timelines, and measurable progress.",
  },
  {
    icon: "/assets/images/icons/Cost-Effective-for-USA-Market.png",
    tag: "Cost-Optimized Solutions",
    title: "Cost-Effective for Global Market",
    desc: "We deliver high-quality Shopify solutions at competitive pricing—making us a trusted, cost-effective development partner for businesses in the USA and beyond.",
  },
  {
    icon: "/assets/images/icons/Ongoing-Support-Maintenance.png",
    tag: "Long-Term Partnership",
    title: "Ongoing Support & Maintenance",
    desc: "From updates and performance optimization to bug fixes and feature enhancements, we provide continuous Shopify support to keep your store running smoothly.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. We build custom Shopify stores, themes, and features tailored to your brand and business needs.",
  },
  {
    id: "collapseThreeB",
    q: "Can you customize existing Shopify themes and apps?",
    a: "Definitely. We customize themes, apps, and integrations to improve store performance and conversions.",
  },
  {
    id: "collapseThreeC",
...
const tags = [
  { label: "Custom Shopify Development", cls: "text-white gradient-bg-six" },
  { label: "Shopify Theme Customization", cls: "text-heading bg-paste" },
  { label: "Shopify App Integration", cls: "text-heading gradient-bg-six" },
  { label: "Shopify Plus Solutions", cls: "text-heading bg-yellow" },
  { label: "Payment Gateway Integration", cls: "text-heading bg-orange" },
  { label: "Third-Party API Integrations", cls: "text-heading gradient-bg-six" },
  { label: "Performance Optimization", cls: "text-heading bg-orange" },
  { label: "Mobile-Optimized Stores", cls: "text-heading gradient-bg-six" },
        ...
        <div className="banner-two__inner position-relative">
          <div className="container">
            <div className="text-center">
              <span className="text-capitalize font-caveat fw-bold tw-mb-6 h3">Scalable Shopify Development </span>
              <div>
                <div className="position-relative d-inline-block">
                  <h1 className="splitTextStyleOne text-capitalize fw-bold tw-leading-none tw-pb-205">
                    For High-Converting eCommerce Stores
                  </h1>
              ...
              <p className="splitTextStyleOne text-neutral-600 tw-text-lg tw-mt-405 tw-mt-8 max-w-672-px mx-auto fw-medium">
                We build fast, secure, and scalable Shopify stores that drive sales for startups and growing brands
                worldwide.
              </p>
            ...
            <div className="col-lg-7 ps-lg-5">
              <div>
                <div className="bg-neutral-100 tw-py-3 tw-px-305 rounded-pill text-heading fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max">
                  ...
                  Up to <span className="text-yellow">90%</span> Higher Conversion with Shopify Solutions
                </div>
                <h2 className="splitTextStyleOne text-heading text-capitalize">
                  Our Shopify Development Solutions
                  <span className="font-dm-serif fst-italic fw-normal"> Build High-Converting</span> Shopify Stores
                </h2>
                <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                  We design and develop powerful, scalable, and user-friendly Shopify stores tailored to your
                  business goals. From custom themes to advanced integrations, we help you create seamless shopping
        ...
        <div className="container max-w-1400-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            <h3 className="splitTextStyleOne text-heading text-capitalize">
              Seamless Shopify Solutions That Drive Online Growth
            </h3>
            <p className="text-neutral-500 tw-mt-5 splitTextStyleOne max-w-500-px mx-auto">
              We build and integrate powerful Shopify solutions into a unified eCommerce ecosystem—ensuring smooth
              operations, better performance, and scalable business growth.
            </p>
          </div>
                ...
                <div className="text-start mx-auto tw-mb-12">
                  <div className="tw-mb-10">
                    <h4 className="tw-mb-2 fw-bold line-clamp-1 font-caveat text-capitalize text-orange">
                      With High-Performance Shopify Solutions…
                    </h4>
                    <h2 className="splitTextStyleOne text-heading text-capitalize max-w-532-px">
                      Fast, Scalable & Secure Shopify Development Solutions
                    </h2>
                    <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                      We build high-performing Shopify stores that are fast, scalable, and future-ready. Our
                      Shopify experts create conversion-focused, API-driven, and integration-ready eCommerce
                      solutions designed to handle high traffic with ease.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container max-w-1552-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <h2 className="splitTextStyleOne text-white">
              Powering High-Converting Stores
              <span className="font-dm-serif fst-italic fw-normal"> With Shopify </span>Expertise
            </h2>
            <p className="text-neutral-300 tw-mt-5 splitTextStyleOne max-w-570-px mx-auto">
              Our Shopify solutions are crafted to boost sales, enhance user experience, and scale your eCommerce
              business—delivering fast, secure, and conversion-focused online stores for startups and enterprises
              alike.
            </p>
          </div>
            ...
            <div className="col-lg-8">
              <div className="ps-xl-5">
                <div className="common-accordion style-two">
                  {faqs.map((faq, i) => (
                    <details className="tw-py-8 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0" key={faq.id} open={i === 1}>
          ...
          <div className="bg-green-deep tw-rounded-3xl tw-pt-100-px position-relative z-1">
            ...
            <div className="tw-mb-8 text-center max-w-570-px mx-auto">
              <div className="tw-py-3 tw-px-305 rounded-pill fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max text-white bg-white-13">
                <div>Build High-Converting Shopify Stores</div>
              </div>
              <h3 className="splitTextStyleOne text-white">Ready to Launch or Scale Your Shopify Store?</h3>
                ...
                <div className="d-flex align-items-center tw-gap-4 justify-content-center flex-wrap">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center tw-gap-2 z-1">
                      <span className="button__label">Start Your Shopify Project</span>
                    </div>
                  </Link>
                  <a
                    href="https://calendly.com/zalgoinfotec/30min"
