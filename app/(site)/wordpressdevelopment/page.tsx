...
export const metadata = buildMetadata({
  ...
  description:
    "Custom WordPress development with secure APIs, third-party integrations, and ongoing maintenance. Scalable, well-structured WordPress sites built to perform.",
  keywords: [
...
const checklist = [
  { icon: "ph-magnifying-glass", text: "Event-driven architecture" },
  { icon: "ph-dresser", text: "Scalable microservices" },
  { icon: "ph-certificate", text: "Secure APIs" },
  { icon: "ph-envelope", text: "Clean & maintainable code" },
];
              ...
              <div className="">
                <div className="text-start mx-auto tw-mb-12">
                  ...
                  <div className="tw-mt-9">
                    ...
                    >
                      <span className="button__flair"></span>
                      <span className="button__label">Talk to Node.js Experts</span>
                    </Link>
                  </div>
                </div>
              </div>
