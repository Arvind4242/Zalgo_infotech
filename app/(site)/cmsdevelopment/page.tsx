...
const aboutThumbs = [
  "/assets/images/service-product/zalgo1.png",
  "/assets/images/service-product/zalgo2.png",
  "/assets/images/service-product/zalgo3.png",
  "/assets/images/service-product/zalgo4.png",
  "/assets/images/service-product/zalgo5.png",
  "/assets/images/service-product/zalgo6.png",
  "/assets/images/service-product/zalgo7.png",
  "/assets/images/service-product/zalgo8.png",
  "/assets/images/service-product/zalgo9.png",
  "/assets/images/service-product/zalgo10.png",
];
...
const checklist = [
  ...
  "Secure role & access control",
];

const seamlessCards = [
  {
    icon: "/assets/images/icons/Custom-Development.png",
    title: "Custom CMS Development",
    desc: "We design tailor-made CMS solutions based on your business workflow, content structure, and scalability needs—giving you complete control without unnecessary complexity.",
  },
  {
    icon: "/assets/images/icons/API-development.png",
    title: "CMS Customization & Extensions",
    desc: "We customize themes, plugins, and CMS modules to extend functionality, improve usability, and align your website perfectly with your brand and business goals.",
  },
  {
    icon: "/assets/images/icons/Third-party-integrations.png",
    title: "Third-party integrations",
    desc: "We seamlessly integrate CRMs, payment gateways, marketing tools, analytics platforms, and cloud services into your CMS to automate processes and boost efficiency.",
  },
  {
    icon: "/assets/images/icons/Maintenance-support.png",
    title: "CMS Maintenance & Support",
    desc: "From security updates and performance optimization to backups and ongoing improvements—we ensure your CMS website stays secure, fast, and up to date.",
  },
];

const roadmapSteps = [
  { num: "01", icon: "roadmap-icon1.svg", label: "Brainstorming", bg: "bg-main-600 tw-mt-705" },
  { num: "02", icon: "roadmap-icon2.svg", label: <>UX <br />Research</>, bg: "bg-dark-deep tw--mt-8-px" },
  { num: "03", icon: "roadmap-icon3.svg", label: "Product Designing", bg: "bg-sky-deep tw-mt-505" },
  { num: "04", icon: "roadmap-icon4.svg", label: "Front-End Development", bg: "bg-dark-deep tw--mt-28-px" },
  { num: "05", icon: "roadmap-icon5.svg", label: <>Usability <br />Testing</>, bg: "bg-dark-deep tw-mt-8" },
  { num: "06", icon: "roadmap-icon6.svg", label: "Back-End Development", bg: "bg-pink tw--mt-8-px" },
  { num: "07", icon: "roadmap-icon7.svg", label: "SEO Optimization", bg: "bg-main-600 tw-mt-4" },
  { num: "08", icon: "roadmap-icon8.svg", label: "Digital Marketing", bg: "bg-sky-deep tw--mt-28-px" },
];

const whyChooseCards = [
  {
    icon: "/assets/images/icons/Why-Choose-Us-for-Nodejs-Development.png",
    tag: "Performance Optimized",
    title: "Easy-to-Manage CMS",
    desc: "We build intuitive CMS platforms that allow you to update pages, blogs, and media effortlessly—no technical expertise required.",
  },
  {
    icon: "/assets/images/icons/Experienced-Nodejs-Team.png",
    tag: "Dedicated Professionals",
    title: "Experienced CMS Team",
    desc: "Our CMS specialists bring deep expertise in WordPress, headless CMS, and custom content platforms tailored to your business needs.",
  },
  {
    icon: "/assets/images/icons/Scalable-Architecture.png",
    tag: "Scalable Systems",
    title: "Scalable CMS Architecture",
    desc: "Our CMS solutions are built to scale smoothly as your content, traffic, and business grow—without performance bottlenecks.",
  },
  {
    icon: "/assets/images/icons/Secure-Backend-Solutions.png",
    tag: "Secure by Design",
    title: "Secure CMS Solutions",
    desc: "We implement robust security measures, access controls, and regular updates to protect your CMS website from vulnerabilities and threats.",
  },
  {
    icon: "/assets/images/icons/API-Integration-Expertise.png",
    tag: "System Connectivity",
    title: "CMS Integration Expertise",
    desc: "We seamlessly integrate your CMS with CRMs, marketing tools, payment gateways, analytics, and third-party services to streamline operations and improve efficiency.",
  },
  {
    icon: "/assets/images/icons/Agile-Transparent-Process.png",
    tag: "Transparent Workflow",
    title: "Agile & Transparent Process",
    desc: "Our agile development approach ensures clear communication, regular updates, and full transparency—keeping you informed at every stage of your CMS project.",
  },
  {
    icon: "/assets/images/icons/Cost-Effective-for-USA-Market.png",
    tag: "Cost-Optimized Solutions",
    title: "Cost-Effective for Global Markets",
    desc: "Get enterprise-grade CMS development at competitive pricing, optimized for global businesses—without compromising on quality, security, or performance.",
  },
  {
    icon: "/assets/images/icons/Ongoing-Support-Maintenance.png",
    tag: "Long-Term Partnership",
    title: "Ongoing CMS Support & Maintenance",
    desc: "We provide continuous monitoring, security updates, performance optimization, and technical support to keep your CMS website running smoothly.",
  },
];
...
const faqs = [
  {
    id: "collapseTwo",
    q: "How do you estimate the project cost?",
    a: "Project cost depends on scope, features, technology stack, and timeline. After a free consultation, we provide a transparent and detailed estimate with no hidden charges.",
  },
  {
    id: "collapseOne",
    q: "What is the typical project timeline?",
    a: "Timelines vary based on complexity and requirements. Small to mid-scale projects usually take 4–8 weeks, while larger applications may take longer. We always share a clear delivery roadmap.",
  },
  {
    id: "collapseThree",
    q: "Which CMS platforms do you work with?",
    a: "We work with WordPress, custom CMS, and headless CMS solutions based on your business requirements.",
  },
  {
    id: "collapseFive",
    q: "Can I manage content easily after development?",
    a: "Yes. We build user-friendly CMS systems that allow you to update content without any technical knowledge.",
  },
  {
    id: "collapseleven",
    q: "Do you sign an NDA?",
    a: "Yes. We sign a Non-Disclosure Agreement (NDA) to ensure complete confidentiality and protect your idea, data, and intellectual property.",
  },
  {
    id: "collapseFour",
    q: "Will I get regular project updates?",
    a: "Absolutely. We follow an agile approach and provide regular updates through email, calls, or project management tools like Jira, Trello, or Slack.",
  },
  {
    id: "collapseSix",
    q: "Can you work with clients in different time zones?",
    a: "Yes. We work with clients across the US, Europe, Middle East, and Asia. Our team is flexible and ensures smooth communication across time zones.",
  },
  {
    id: "collapseseven",
    q: "Who owns the source code?",
    a: "Once the project is completed and payment terms are fulfilled, you own 100% of the source code and intellectual property.",
  },
  {
    id: "collapseeight",
    q: "How do we get started?",
    a: "Simply click on “Get a Free Consultation” or “Request a Quote”, share your requirements, and our experts will get in touch within 24 hours.",
  },
  {
    id: "collapsenine",
    q: "Can you scale the team if my project grows?",
    a: "Yes. We can quickly scale resources based on your project needs, whether you require additional developers, AI engineers, or long-term support.",
  },
  {
    id: "collapseTen",
    q: "Do you provide post-launch support and maintenance?",
    a: "Yes. We offer ongoing support, maintenance, performance optimization, and feature enhancements after project delivery.",
  },
];
...
const testimonials = [
  {
    ...
    video: "/assets/images/case-study/finance-case-study.png",
    quote:
  ...
  },
  {
    ...
    name: "Roland Thomas",
    role: "CEO - and Founder",
    iframe: "https://www.youtube.com/embed/TxjsRFwDvbQ?si=LA4zrJXjOhfKCdMM",
    quote:
  ...
  },
  {
    ...
    video: "/assets/images/case-study/edmilson-testi.png",
    quote:
...
const tags = [
  { label: "Custom CMS Development", cls: "text-white gradient-bg-six" },
  { label: "WordPress & Headless CMS", cls: "text-heading bg-paste" },
  { label: "Easy Content Management", cls: "text-heading gradient-bg-six" },
  { label: "Secure CMS Architecture", cls: "text-heading bg-yellow" },
  { label: "Scalable Website Solutions", cls: "text-heading bg-orange" },
  { label: "Third-Party Integrations", cls: "text-heading gradient-bg-six" },
  { label: "SEO-Friendly CMS", cls: "text-heading bg-orange" },
  { label: "Fast Performance", cls: "text-heading gradient-bg-six" },
  { label: "Ongoing Support", cls: "text-heading bg-paste" },
  { label: "Quality Assurance", cls: "text-heading bg-pink" },
];
        ...
        <div className="banner-two__inner position-relative">
          <div className="container">
            <div className="text-center">
              <span className="text-capitalize font-caveat fw-bold tw-mb-6 h3">Powerful CMS Websites </span>
              <div>
                <div className="position-relative d-inline-block">
                  <h1 className="splitTextStyleOne text-capitalize fw-bold tw-leading-none tw-pb-205">
                    That Are Easy to Manage & Built to Scale
                  </h1>
              ...
              <p className="splitTextStyleOne text-neutral-600 tw-text-lg tw-mt-405 tw-mt-8 max-w-672-px mx-auto fw-medium">
                We design and develop secure, flexible, and user-friendly CMS websites that give you full control
                over your content, improve performance, and support long-term business growth—without technical
                complexity.
              </p>
                ...
                <div className="d-flex tw-gap-6 tw-max-h-666-px">
                  <div className="swiper overflow-hidden about-two-thumbs-slider-one w-50">
                    <div className="swiper-wrapper transition-timing-linear tw-gap-6">
                      {aboutThumbs.map((src, i) => (
                        <div className="swiper-slide" key={`s1-${i}`}>
                          <div className="tw-rounded-2xl overflow-hidden">
                            <img src={src} alt="Image" className="w-100 h-100 object-fit-cover" />
                          </div>
                        </div>
                      ))}
                    </div>
            ...
            <div className="col-lg-7 ps-lg-5">
              <div>
                <div className="bg-neutral-100 tw-py-3 tw-px-305 rounded-pill text-heading fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max">
                  ...
                  Up to <span className="text-yellow">80%</span> Easier Content Management & Faster Updates
                </div>
                <h2 className="splitTextStyleOne text-heading text-capitalize">
                  Our CMS Website Solutions
                  <span className="font-dm-serif fst-italic fw-normal"> Simplify Content.</span> Scale Your
                  Business.
                </h2>
                <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                  We build robust, secure, and easy-to-manage CMS websites that allow you to update content,
                  manage pages, and control your digital presence effortlessly. Our CMS solutions are designed for
                  performance, flexibility, and long-term scalability—so your website grows with your business.
                </p>
        ...
        <div className="container max-w-1400-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            <h3 className="splitTextStyleOne text-heading text-capitalize">
              Seamless CMS Solutions That Empower Your Digital Presence
            </h3>
            <p className="text-neutral-500 tw-mt-5 splitTextStyleOne max-w-500-px mx-auto">
              We build intelligent CMS ecosystems that simplify content management, enhance collaboration, and
              ensure your website remains scalable, secure, and performance-driven as your business evolves.
            </p>
          </div>

          <div className="border border-neutral-200 tw-rounded-xl common-shadow-sixteen">
            <div className="row col-border-wrapper">
              {seamlessCards.map((card) => (
                <div className="col-xl-3 col-md-6 col-sm-6 col-xs-12 border-0" key={card.title}>
                ...
                <div className="flex-grow-1">
                  <div className="d-flex tw-gap-3 flex-wrap">
                    {roadmapSteps.map((step) => (
                      <div
                        key={step.num}
                        className={`ball text-center rounded-circle tw-w-180-px tw-h-180-px d-flex flex-column justify-content-center align-items-center position-relative animation-item ${step.bg}`}
                      >
                ...
                <div className="text-start mx-auto tw-mb-12">
                  <div className="tw-mb-10">
                    <h4 className="tw-mb-2 fw-bold line-clamp-1 font-caveat text-capitalize text-orange">
                      With Powerful & Flexible CMS Platforms…
                    </h4>
                    <h2 className="splitTextStyleOne text-heading text-capitalize max-w-532-px">
                      Fast, Secure & Scalable CMS Website Solutions
                    </h2>
                    <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                      We build high-performance CMS websites that are easy to manage, secure by design, and built
                      to scale. Our CMS solutions empower your team to update content effortlessly while ensuring
                      optimal speed, SEO readiness, and long-term stability for growing digital businesses.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container max-w-1552-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            <div className="bg-white-06 tw-py-3 tw-px-305 rounded-pill text-white fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max">
              <span className="tw-w-205 tw-h-205 bg-yellow rounded-circle"></span>
              Why Choose Zalgo Infotech for CMS Development
            </div>
            <h2 className="splitTextStyleOne text-white">
              Powering Modern Websites
              <span className="font-dm-serif fst-italic fw-normal"> With Smart </span>CMS Solutions
            </h2>
            <p className="text-neutral-300 tw-mt-5 splitTextStyleOne max-w-570-px mx-auto">
              Our CMS solutions are designed for flexibility, security, and ease of management—helping businesses
              control content efficiently while scaling without limitations.
            </p>
          </div>
          ...
          <div className="service-slider-grid">
            <div className="d-flex flex-wrap gap-3 why-choose-us">
              {whyChooseCards.map((card) => (
                <div className="swiper-slide w-25 tw-pb-105" key={card.title}>
                  <div className="square-bg-shape position-relative tw-rounded-2xl z-1 animation-item tw-h-424-px">
                    <div className="service-item bg-white hover-bg-main-600 group group-item tw-py-16 tw-ps-10 tw-pe-4 tw-rounded-2xl h-100 d-flex flex-column justify-content-center tw-duration-200">
                      <span className="tw-mb-13 group-hover-item-text-invert">
                        <img src={card.icon} alt="Icon" className="animate__heartBeat" />
                      </span>
                      <div>
      ...
      <section className="testimonials py-120 bg-neutral-50 position-relative z-1">
        ...
        <div className="container">
          ...
          <div className="d-flex tw-gap-6 testimonials-item-wrapper flex-wrap">
            {testimonials.map((t) => (
              <div className="testimonials-item cursor-pointer bg-white tw-rounded-28-px border border-neutral-100" key={t.name}>
                <div className="current-content">
                  <div className="tw-max-h-397-px overflow-hidden text-center">
                    <img src={t.img} alt="Image" />
                  </div>
                  <div className="tw-py-8 tw-px-4 text-center">
                    ...
                    <span className="text-neutral-600 fw-medium tw-text-sm">
                      <span className="fw-semibold text-neutral-600">{t.role}</span>
                    </span>
                  </div>
                </div>
                ...
                <div className="d-flex flex-column h-100 hidden-content p-3">
                  ...
                  <div className="d-flex align-items-center tw-gap-6 tw-duration-200">
                    <div className="tw-h-84-px tw-w-84-px rounded-circle">
                      <img src={t.shortImg} alt="Image" className="w-100 h-100 object-fit-cover" />
                    </div>
                    <div>
                      <h6 className="tw-mb-2">{t.name}</h6>
          ...
          <div className="row gy-4">
            <div className="col-lg-4">
              <div>
                ...
                <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-350-px fw-medium">
                  Everything you need to know about our development services, timelines, and engagement
            ...
            <div className="col-lg-8">
              <div className="ps-xl-5">
                <div className="common-accordion style-two">
                  {faqs.map((faq, i) => (
                    <details className="tw-py-8 tw-px-40-px tw-rounded-xl bg-transparent border-0 mb-0" key={faq.id} open={i === 0}>
                      <summary className="shadow-none p-0 line-clamp-3 bg-transparent h5" style={{ cursor: "pointer" }}>
                        <span>❓</span> {faq.q}
                      </summary>
                      <div className="p-0 tw-mt-605 max-w-620-px">
          ...
          <div className="bg-green-deep tw-rounded-3xl tw-pt-100-px position-relative z-1">
            ...
            <div className="tw-mb-8 text-center max-w-570-px mx-auto">
              <div className="tw-py-3 tw-px-305 rounded-pill fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max text-white bg-white-13">
                <div>Build Smart & Scalable CMS Websites</div>
              </div>
              <h3 className="splitTextStyleOne text-white">
                Ready to Build a Powerful CMS Website for Your Business?
              </h3>
                ...
                <div className="d-flex align-items-center tw-gap-4 justify-content-center flex-wrap">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center tw-gap-2 z-1">
                      <span className="button__label">Start Your CMS Project</span>
                    </div>
                  </Link>
                  <a
                    target="_blank"
