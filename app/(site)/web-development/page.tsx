...
export const metadata = buildMetadata({
  ...
  description:
    "Custom, SEO-friendly web development with secure APIs, third-party integrations, and ongoing maintenance. Responsive, scalable websites built for growth.",
  keywords: [
...
const aboutThumbs = [
  "/assets/images/thumbs/wb1.png",
  "/assets/images/thumbs/wb2.png",
  "/assets/images/thumbs/wb3.png",
  "/assets/images/thumbs/wb4.png",
  "/assets/images/thumbs/wb5.png",
  "/assets/images/thumbs/wb1.png",
  "/assets/images/thumbs/wb2.png",
  "/assets/images/thumbs/wb3.png",
  "/assets/images/thumbs/wb4.png",
...
const seamlessCards = [
  {
    ...
    desc: "We design and develop tailor-made websites and web applications based on your business objectives—ensuring flexibility, performance, and long-term scalability.",
  },
  {
    icon: "/assets/images/icons/API-development.png",
    title: "Web API Development",
    desc: "We build secure, high-performance APIs that enable seamless communication between front-end, backend, and third-party systems.",
  },
  {
    icon: "/assets/images/icons/Third-party-integrations.png",
    title: "Third-party integrations",
    desc: "We integrate CRMs, payment gateways, analytics tools, marketing platforms, and cloud services to streamline workflows and improve operational efficiency.",
  },
  {
    icon: "/assets/images/icons/Maintenance-support.png",
    title: "Maintenance & support",
    desc: "We provide continuous monitoring, updates, security patches, and technical support to keep your website fast, secure, and always up to date.",
  },
];
...
const whyChooseCards = [
  {
    ...
    desc: "We build fast, responsive, and optimized websites designed to deliver smooth user experiences, high conversions, and reliable performance across all devices.",
  },
  {
    icon: "/assets/images/icons/Experienced-Nodejs-Team.png",
    tag: "Proven Industry Experience",
    title: "Experienced Web Development Team",
    desc: "Our skilled developers bring deep expertise in modern frameworks, UI/UX best practices, and backend systems to deliver reliable and future-ready web solutions.",
  },
  {
    icon: "/assets/images/icons/Scalable-Architecture.png",
    tag: "Built for Growth",
    title: "Scalable Website Architecture",
    desc: "We design scalable web architectures that grow with your business—handling increasing traffic, content, and integrations without compromising performance.",
  },
  {
    icon: "/assets/images/icons/Secure-Backend-Solutions.png",
    tag: "Advanced Protection",
    title: "Secure Web Solutions",
    desc: "We follow industry-standard security practices to protect your website from vulnerabilities, ensure data safety, and maintain long-term stability.",
  },
  {
    icon: "/assets/images/icons/API-Integration-Expertise.png",
    tag: "Custom API Solutions",
    title: "API & Integration Expertise",
    desc: "We integrate your website with third-party tools, CRMs, payment gateways, analytics platforms, and marketing systems to ensure smooth data flow and better operational efficiency.",
  },
  {
    icon: "/assets/images/icons/Agile-Transparent-Process.png",
    tag: "Client-Centric Approach",
    title: "Agile & Transparent Development Process",
    desc: "We follow an agile web development approach with clear communication, regular updates, and milestone-based delivery—so you stay informed at every stage of the project.",
  },
  {
    icon: "/assets/images/icons/Cost-Effective-for-USA-Market.png",
    tag: "Value-Driven Pricing",
    title: "Cost-Effective for Global Markets",
    desc: "Get high-quality web development services at competitive pricing without compromising on performance, security, or design—ideal for startups, SMEs, and international clients.",
  },
  {
    icon: "/assets/images/icons/Ongoing-Support-Maintenance.png",
    tag: "Long-Term Partnership",
    title: "Ongoing Support & Maintenance",
    desc: "We provide continuous website support, updates, security patches, and performance monitoring to keep your web platform stable, secure, and up to date.",
  },
];
...
const faqs = [
  ...
  {
    id: "collapseThree",
    q: "Do you build custom and responsive websites?",
    a: "Yes. We create fully custom, mobile-responsive, and fast-loading websites tailored to your business goals and brand identity.",
  },
  {
    id: "collapseFive",
    q: "Will my website be SEO-friendly and optimized?",
    a: "Definitely. All our websites are built with clean code, SEO best practices, and performance optimization from day one.",
  },
  {
    id: "collapseleven",
...
const tags = [
  { label: "Web Development", cls: "text-white gradient-bg-six" },
  { label: "Responsive Design", cls: "text-heading bg-paste" },
  { label: "SEO-Optimized Code", cls: "text-heading gradient-bg-six" },
  { label: "Fast & Secure Websites", cls: "text-heading bg-yellow" },
  { label: "Scalable Solutions", cls: "text-heading bg-orange" },
  { label: "UI/UX Focused", cls: "text-heading gradient-bg-six" },
  { label: "API Integrations", cls: "text-heading bg-orange" },
  { label: "Quality Assurance", cls: "text-heading gradient-bg-six" },
  { label: "On-Time Delivery", cls: "text-heading bg-paste" },
  { label: "Maintenance & Support", cls: "text-heading bg-pink" },
];
        ...
        <div className="banner-two__inner position-relative">
          <div className="container">
            <div className="text-center">
              <span className="text-capitalize font-caveat fw-bold tw-mb-6 h3">Custom Web Development </span>
              <div>
                <div className="position-relative d-inline-block">
                  <h1 className="splitTextStyleOne text-capitalize fw-bold tw-leading-none tw-pb-205">
                    That Drives Growth & Conversions
                  </h1>
              ...
              <p className="splitTextStyleOne text-neutral-600 tw-text-lg tw-mt-405 tw-mt-8 max-w-672-px mx-auto fw-medium">
                We design and develop fast, secure, and responsive websites that help businesses build trust, engage
                users, and grow online—globally.
              </p>
            ...
            <div className="col-lg-7 ps-lg-5">
              <div>
                <div className="bg-neutral-100 tw-py-3 tw-px-305 rounded-pill text-heading fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max">
                  ...
                  Up to <span className="text-yellow">3x</span> Faster Load Times & Better User Engagement
                </div>
                <h2 className="splitTextStyleOne text-heading text-capitalize">
                  Our Web Development Services
                  <span className="font-dm-serif fst-italic fw-normal"> Built for Performance,</span> Security &
                  Growth
                </h2>
                <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                  We develop high-performance websites and web applications designed to handle growing traffic,
                  complex workflows, and evolving business needs—without compromising on speed or security.
                </p>
        ...
        <div className="container max-w-1400-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            <h3 className="splitTextStyleOne text-heading text-capitalize">
              Seamless Web Solutions That Enhance User Experience & Business Growth
            </h3>
            <p className="text-neutral-500 tw-mt-5 splitTextStyleOne max-w-500-px mx-auto">
              We bring together design, development, and modern technologies to deliver smooth, scalable, and
              conversion-focused web solutions—ensuring your website performs flawlessly at every stage of
              growth.
            </p>
          </div>
          ...
          <div className="row gy-5 align-items-center flex-wrap-reverse">
            <div className="col-xl-6">
              <div className="position-relative tw-p-12 text-center">
                ...
                <img
                  src="/assets/images/shapes/web-development2.png"
                  alt="Icons"
                  className="position-absolute top-50 start-50 animation-rotate-right"
                />
                <img
                  src="/assets/images/shapes/web-development.png"
                  alt="Icons"
                ...
                <div className="text-start mx-auto tw-mb-12">
                  <div className="tw-mb-10">
                    ...
                    <h2 className="splitTextStyleOne text-heading text-capitalize max-w-532-px">
                      Fast, Responsive & Secure Web Development Solutions
                    </h2>
                    <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                      We build high-performance websites that are fast, responsive, and future-ready. Our web
                      development solutions focus on clean architecture, optimized performance, and strong
                      security—ensuring smooth user experiences even with growing traffic and business demands.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container max-w-1552-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <h2 className="splitTextStyleOne text-white">
              ...
              <span className="font-dm-serif fst-italic fw-normal"> With Expert </span>Web Development
            </h2>
            <p className="text-neutral-300 tw-mt-5 splitTextStyleOne max-w-570-px mx-auto">
              Our web development solutions are built for speed, scalability, and security—helping businesses
              create impactful digital experiences that drive engagement and growth.
            </p>
          </div>
          ...
          <div className="bg-green-deep tw-rounded-3xl tw-pt-100-px position-relative z-1">
            ...
            <div className="tw-mb-8 text-center max-w-570-px mx-auto">
              <div className="tw-py-3 tw-px-305 rounded-pill fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max text-white bg-white-13">
                <div>Professional Web Development Services</div>
              </div>
              <h3 className="splitTextStyleOne text-white">Ready to Build a Powerful Website for Your Business?</h3>
                ...
                <div className="d-flex align-items-center tw-gap-4 justify-content-center flex-wrap">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center tw-gap-2 z-1">
                      <span className="button__label">Start Your Web Development Project</span>
                    </div>
                  </Link>
                  <a
                    target="_blank"
