...
const aboutThumbs = [
  "about-slide-img1.png",
  "about-slide-img2.png",
  "about-slide-img3.png",
  "about-slide-img1.png",
  "about-slide-img2.png",
  "about-slide-img3.png",
  "about-slide-img1.png",
...
const seamlessCards = [
  {
    ...
    desc: "We design and develop tailor-made ecommerce platforms aligned with your business goals—delivering fast performance, intuitive UX, and long-term scalability.",
  },
  {
    icon: "API-development.png",
    title: "Payment & Checkout Integration",
    desc: "We implement secure, high-converting checkout systems with multiple payment gateways—ensuring faster transactions and reduced cart abandonment.",
  },
  {
    icon: "Third-party-integrations.png",
    title: "Third-Party Ecommerce Integrations",
    desc: "We integrate CRMs, ERPs, shipping providers, analytics, marketing tools, and marketplaces—streamlining operations and automating your ecommerce workflow.",
  },
  {
    icon: "Maintenance-support.png",
    title: "Maintenance & support",
    desc: "From updates and security patches to performance optimization and monitoring—we keep your ecommerce store secure, fast, and running smoothly 24/7.",
  },
];
...
const whyChooseUs = [
  {
    ...
    desc: "We build fast, reliable, and conversion-focused ecommerce platforms optimized for speed, scalability, and seamless shopping experiences across all devices.",
  },
  {
    icon: "Experienced-Nodejs-Team.png",
    badge: "Dedicated Professionals",
    title: "Experienced Ecommerce Team",
    desc: "Our skilled ecommerce developers deliver custom online stores, marketplaces, and scalable solutions tailored to your business goals.",
  },
  {
    icon: "Scalable-Architecture.png",
    badge: "Built for Growth",
    title: "Scalable Ecommerce Architecture",
    desc: "We design future-ready ecommerce architectures that support high traffic, secure transactions, and smooth performance during peak sales.",
  },
  {
    icon: "Secure-Backend-Solutions.png",
    badge: "Advanced Protection",
    title: "Secure Ecommerce Solutions",
    desc: "We implement advanced security measures to protect customer data, payments, and transactions—ensuring a safe and trustworthy ecommerce platform.",
  },
  {
    icon: "API-Integration-Expertise.png",
    badge: "System Connectivity",
    title: "Ecommerce API & Integration Expertise",
    desc: "From payment gateways and shipping APIs to CRM, ERP, and third-party tools, we ensure smooth, secure, and reliable ecommerce system integrations.",
  },
  {
    icon: "Agile-Transparent-Process.png",
    badge: "Agile Methodology",
    title: "Agile & Transparent Development Process",
    desc: "We follow an agile ecommerce development approach with clear communication, regular updates, and full transparency at every stage of the project.",
  },
  {
    icon: "Cost-Effective-for-USA-Market.png",
    badge: "Cost-Optimized Solutions",
    title: "Cost-Effective for Global Markets",
    desc: "Our ecommerce solutions are designed to deliver high quality at competitive pricing—making them ideal for startups, SMEs, and enterprise businesses worldwide.",
  },
  {
    icon: "Ongoing-Support-Maintenance.png",
    badge: "Long-Term Partnership",
    title: "Ongoing Support & Maintenance",
    desc: "We provide continuous ecommerce support, updates, and performance optimization to keep your online store secure, fast, and always up to date.",
  },
];
...
const faqItems = [
  ...
  {
    question: "Do you build scalable and secure eCommerce websites?",
    answer:
          ...
          <div className="container">
            <div className="text-center">
              <span className="text-capitalize font-caveat fw-bold tw-mb-6 h3">
                Scalable Ecommerce Development
              </span>
              <div className="">
              ...
              <p className="splitTextStyleOne text-neutral-600 tw-text-lg tw-mt-405 tw-mt-8 max-w-672-px mx-auto fw-medium">
                We build fast, secure, and scalable E-commerce solutions that drive sales and deliver seamless shopping
            ...
            <div className="col-lg-7 ps-lg-5">
              <div className="">
                <div className="bg-neutral-100 tw-py-3 tw-px-305 rounded-pill text-heading fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max">
                  ...
                  Up to <span className="text-yellow">3X </span>Higher Conversions with Scalable Ecommerce Solutions
                </div>
                <h2 className="splitTextStyleOne text-heading text-capitalize">
                  Our Ecommerce Solutions
                  <span className="font-dm-serif fst-italic fw-normal"> Power High-Converting </span>
                  Online Stores
                </h2>
                <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                  We build fast, secure, and scalable ecommerce applications designed to handle high traffic, seamless
                  payments, and complex product catalogs—helping your online store convert more visitors into loyal
                  customers as you grow.
                </p>
                ...
                <div className="tw-mt-8 max-w-500-px">
                  ...
                  >
                    <span className="button__flair"></span>
                    <span className="button__label">Talk to Our Ecommerce Experts</span>
                  </Link>
                </div>
              </div>
            </div>
        ...
        <div className="container max-w-1400-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            <h3 className="splitTextStyleOne text-heading text-capitalize">
              Seamless Ecommerce Solutions That Drive Sales & Customer Experience
            </h3>
            <p className="text-neutral-500 tw-mt-5 splitTextStyleOne max-w-500-px mx-auto">
              We build and integrate powerful ecommerce systems that work together flawlessly—ensuring smooth shopping
              journeys, secure transactions, and scalable online growth.
            </p>
          </div>
          ...
          <div className="row gy-5 align-items-center flex-wrap-reverse">
            <div className="col-xl-6">
              <div className="position-relative tw-p-12 text-center">
                ...
                <img
                  src="/assets/images/shapes/e-commerce-development2.png"
                  alt="Icons"
                  className="position-absolute top-50 start-50 animation-rotate-right"
                />
                <img
                  src="/assets/images/shapes/e-commerce-development.png"
                  alt="Icons"
              ...
              <div className="">
                <div className="text-start mx-auto tw-mb-12">
                  <div className="tw-mb-10">
                    ...
                    <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                      We build high-performance ecommerce solutions that are fast, secure, and conversion-focused. Our
                      expert developers create custom ecommerce websites, marketplace platforms, and mobile-friendly
                      online stores designed to handle high traffic, seamless payments, and smooth user experiences
                      with ease.
                    </p>
                  </div>
                </div>
        ...
        <div className="container max-w-1552-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <h2 className="splitTextStyleOne text-white">
              ...
              <span className="font-dm-serif fst-italic fw-normal"> With Ecommerce</span> Expertise
            </h2>
            <p className="text-neutral-300 tw-mt-5 splitTextStyleOne max-w-570-px mx-auto">
              Our ecommerce solutions are built for performance, scalability, and security—helping businesses create
              seamless shopping experiences that drive sales and long-term growth.
            </p>
          </div>
          ...
          <div className="bg-green-deep tw-rounded-3xl bg-green-deep tw-pt-100-px position-relative z-1">
            ...
            <div className="tw-mb-8 text-center max-w-570-px mx-auto">
              <div className="tw-py-3 tw-px-305 rounded-pill fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max text-white bg-white-13">
                <div className="">Launch • Scale • Sell More Online</div>
              </div>
              <h3 className="splitTextStyleOne text-white">Turn Your Idea into a High-Converting E-commerce Store</h3>
                ...
                <div className="d-flex align-items-center tw-gap-4 justify-content-center flex-wrap">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center tw-gap-2 z-1">
                      <span className="button__label">Start Your E-commerce Project</span>
                    </div>
                  </Link>
                  <a
                    href="https://calendly.com/zalgoinfotec/30min"
