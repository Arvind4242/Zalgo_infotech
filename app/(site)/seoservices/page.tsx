...
const roadmapSteps = [
  { num: "01", title: "Keyword Research", bg: "bg-main-600", mt: "tw-mt-705" },
  { num: "02", title: "SEO Audit", bg: "bg-dark-deep", mt: "tw--mt-8-px" },
  { num: "03", title: "On-Page Optimization", bg: "bg-sky-deep", mt: "tw-mt-505" },
  { num: "04", title: "Technical SEO", bg: "bg-dark-deep", mt: "tw--mt-28-px" },
  { num: "05", title: "Content Optimization", bg: "bg-dark-deep", mt: "tw-mt-8" },
  { num: "06", title: "Link Building", bg: "bg-pink", mt: "tw--mt-8-px" },
  { num: "07", title: "Performance Tracking", bg: "bg-main-600", mt: "tw-mt-4" },
  { num: "08", title: "Growth Optimization", bg: "bg-sky-deep", mt: "tw--mt-28-px" },
];

const seamlessCards = [
  {
    icon: "On-Page-SEO.png",
    title: "On-Page SEO",
    desc: "We optimize content, meta tags, and site structure to improve search visibility and user experience.",
  },
  {
    icon: "Technical-SEO.png",
    title: "Technical SEO",
    desc: "We fix site speed, indexing, crawl issues, and technical errors to boost search performance.",
  },
  {
    icon: "Content-Link-Building.png",
    title: "Content & Link Building",
    desc: "We create SEO-friendly content and build quality backlinks to strengthen your online authority.",
  },
  {
    icon: "SEO-Monitoring-Support.png",
    title: "SEO Monitoring & Support",
    desc: "Ongoing tracking, reporting, and optimization to keep your rankings stable and growing.",
  },
];
...
const serviceItems = [
  {
    ...
    title: "High-Impact SEO Strategy",
    desc: "We craft data-driven SEO strategies focused on increasing organic traffic, improving rankings, and driving qualified leads that convert.",
  },
  {
    icon: "Experienced-Nodejs-Team.png",
    tag: "Industry Experts",
    title: "Experienced SEO Experts",
    desc: "Our SEO specialists bring years of hands-on experience across industries, delivering proven results with ethical, white-hat techniques.",
  },
  {
    icon: "Scalable-Architecture.png",
    tag: "Growth-Ready SEO",
    title: "Scalable SEO Solutions",
    desc: "From startups to enterprises, our SEO solutions scale with your business—covering on-page, off-page, technical SEO, and content optimization.",
  },
  {
    icon: "Secure-Backend-Solutions.png",
    tag: "ROI-Focused SEO",
    title: "Result-Oriented Optimization",
    desc: "We focus on measurable outcomes like higher search visibility, better keyword rankings, improved CTR, and long-term ROI.",
  },
  {
    icon: "API-Integration-Expertise.png",
    tag: "High-Intent Keyword Targeting",
    title: "Advanced Keyword Research",
    desc: "We identify high-intent keywords that your target audience is searching for, ensuring better rankings and qualified organic traffic.",
  },
  {
    icon: "Agile-Transparent-Process.png",
    tag: "Site Health Optimization",
    title: "Technical SEO Optimization",
    desc: "We optimize site speed, crawlability, indexing, and core web vitals to ensure search engines can easily discover and rank your website.",
  },
  {
    icon: "Cost-Effective-for-USA-Market.png",
    tag: "Conversion-Focused Content",
    title: "Content Optimization & Strategy",
    desc: "Our SEO-driven content strategies improve relevance, engagement, and authority to help your pages rank higher in search results.",
  },
  {
    icon: "Ongoing-Support-Maintenance.png",
    tag: "Monthly Growth Reports",
    title: "SEO Analytics & Reporting",
    desc: "Get transparent performance reports with keyword rankings, traffic insights, and conversion tracking for data-backed decisions.",
  },
];
...
const faqs = [
  {
    ...
    a: "We offer complete SEO solutions including website audit, keyword research, on-page SEO, technical SEO, content optimization, link building, and local SEO to improve search visibility and organic traffic.",
    show: true,
  },
  {
    id: "collapseOne",
    q: "How long does SEO take to show results?",
    a: "SEO is a long-term strategy. Initial improvements can be seen in 6–8 weeks, while strong and consistent results usually take 3–6 months depending on competition and website condition.",
  },
  {
    id: "collapseThree",
    q: "How do you measure SEO success?",
    a: "We track keyword rankings, organic traffic, conversions, click-through rates (CTR), and overall ROI using tools like Google Analytics and Search Console.",
  },
  {
    id: "collapseFour",
    q: "Will my website rank #1 on Google?",
    a: "No ethical SEO agency can guarantee #1 rankings. What we guarantee is a data-driven strategy that improves visibility, traffic quality, and business growth.",
  },
  {
    id: "collapseSix",
    q: "Do you provide SEO reports?",
    a: "Yes. We provide detailed monthly SEO reports covering rankings, traffic growth, completed tasks, and performance insights.",
  },
  {
    id: "collapseseven",
    q: "Can SEO help generate leads and sales?",
    a: "Yes. SEO attracts high-intent users who are actively searching for your services, resulting in better lead quality and long-term sales growth.",
  },
  {
    id: "collapseeight",
    q: "Do you offer SEO for startups and small businesses?",
    a: "Yes. We provide scalable SEO plans tailored for startups, small businesses, and enterprises based on goals and budget.",
  },
  {
    id: "collapsenine",
    q: "Is SEO a one-time service or ongoing?",
    a: "SEO is an ongoing process. Search engine algorithms, competitors, and user behavior change regularly, so continuous optimization is required for sustainable rankings.",
  },
  {
    id: "collapseTen",
    q: "Do you follow Google SEO guidelines?",
    a: "Yes. We strictly follow Google’s white-hat SEO guidelines to ensure safe, ethical, and long-lasting results without risking penalties.",
  },
];

const dragTags = [
  { label: "Technical SEO", bg: "gradient-bg-six", text: "text-white" },
  { label: "On-Page SEO", bg: "bg-paste", text: "text-heading" },
  { label: "Off-Page SEO", bg: "gradient-bg-six", text: "text-heading" },
  { label: "Keyword Research", bg: "bg-yellow", text: "text-heading" },
  { label: "Content Optimization", bg: "bg-orange", text: "text-heading" },
  { label: "Local SEO", bg: "gradient-bg-six", text: "text-heading" },
  { label: "E-commerce SEO", bg: "bg-orange", text: "text-heading" },
  { label: "Link Building", bg: "gradient-bg-six", text: "text-heading" },
  { label: "SEO Audits", bg: "bg-paste", text: "text-heading" },
  { label: "White-Hat SEO", bg: "bg-pink", text: "text-heading" },
];
        ...
        <div className="banner-two__inner position-relative">
          <div className="container">
            <div className="text-center">
              <span className="text-capitalize font-caveat fw-bold tw-mb-6 h3">Scalable SEO Services</span>
              <div>
              ...
              >
                ...
                >
                  ...
                  <span className="button__label">Get a Free SEO Audit</span>
                </a>
                <Link
                  href={routes.contact}
            ...
            <div className="col-lg-7 ps-lg-5">
              <div>
                ...
                >
                  ...
                  Up to <span className="text-yellow">3X</span>More Traffic with Result-Driven SEO
                </div>
                <h2 className="splitTextStyleOne text-heading text-capitalize">
                  Our SEO Services
                  <span className="font-dm-serif fst-italic fw-normal">Drive Rankings,</span>
                  Traffic & Real Growth
                </h2>
                <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                  We optimize your website to rank higher on search engines, attract the right audience, and convert
                  organic traffic into real business growth.
                </p>
        ...
        <div className="container max-w-1400-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <p className="text-neutral-500 tw-mt-5 splitTextStyleOne max-w-500-px mx-auto">
              We optimize your website for better rankings, higher visibility, and consistent organic traffic that
              converts into business results.
            </p>
          </div>
                ...
                <div className="max-w-432-px w-100 flex-shrink-0">
                  <div className="pt-120 tw-pb-9 position-relative">
                    ...
                    <h3 className="splitTextStyleOne fw-light tw-leading-104 text-white tw-mb-6">
                      <span className="d-inline-block fw-semibold">Our SEO Working Roadmap</span>
                    </h3>
                    <p className="splitTextStyleOne text-neutral-400 max-w-432-px">
                      A simple, transparent process to improve rankings, attract the right traffic, and grow your
          ...
          <div className="row gy-5 align-items-center flex-wrap-reverse">
            ...
            >
              <div className="position-relative tw-p-12 text-center">
                ...
                <img
                  src="/assets/images/shapes/seo-services2.png"
                  alt="Icons"
                  className="position-absolute top-50 start-50 animation-rotate-right"
                />
                <img
                  src="/assets/images/shapes/seo-services.png"
                  alt="Icons"
                ...
                <div className="text-start mx-auto tw-mb-12">
                  <div className="tw-mb-10">
                    <h4 className="tw-mb-2 fw-bold line-clamp-1 font-caveat text-capitalize text-orange">
                      With Result-Driven SEO Strategies&hellip;
                    </h4>
                    ...
                    <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                      We help businesses improve search visibility, drive high-quality organic traffic, and convert
                      visitors into customers. Our SEO experts craft data-driven, white-hat strategies focused on
                      long-term growth, higher rankings, and measurable ROI.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container max-w-1552-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <h2 className="splitTextStyleOne text-white">
              SEO That
              <span className="font-dm-serif fst-italic fw-normal"> Delivers</span> <br />
              Real Results
            </h2>
          ...
          <div className="bg-green-deep tw-rounded-3xl bg-green-deep tw-pt-100-px position-relative z-1">
            ...
            <div className="tw-mb-8 text-center max-w-570-px mx-auto">
              <div
                ...
                data-aos-anchor-placement="top-bottom"
              >
                <div>Grow Your Business with Proven SEO Strategies</div>
              </div>
                ...
                <div className="d-flex align-items-center tw-gap-4 justify-content-center flex-wrap">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center tw-gap-2 z-1">
                      <span className="button__label">Start Your SEO Campaign</span>
                    </div>
                  </Link>
                  <a
                    href="https://calendly.com/zalgoinfotec/30min"
