...
export const metadata = buildMetadata({
  ...
  description:
    "See what it's like to work at Zalgo Infotech — open communication, continuous learning, work-life balance, and a team behind 40+ successful projects worldwide.",
  keywords: [
