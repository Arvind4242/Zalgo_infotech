...
// NOTE: The original Laravel view for this route (frontend/pages/industry.blade.php) is a
// byte-for-byte duplicate of appIntigration.blade.php (confirmed via diff against the source
// repo) — including its `@section('title', 'App Intigration')` line. Preserved here for fidelity
// with the live site rather than corrected, since this is a like-for-like port.
import { buildMetadata } from "@/lib/seo";

export const metadata = buildMetadata({
  title: "Industries We Serve",
  description:
    "Zalgo Infotech delivers tailored IT and software solutions across industries — with seamless integrations and tools built to fit your sector's unique workflows.",
  keywords: [
    "industries we serve",
    "industry-specific IT solutions",
    "software for industries",
    "vertical software solutions",
    "Zalgo Infotech industries",
  ],
  path: "/industry",
});
