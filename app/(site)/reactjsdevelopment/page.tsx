...
export const metadata = buildMetadata({
  ...
  description:
    "Blazing-fast, SEO-first React & Next.js development with pixel-perfect UI, seamless API integration, and ongoing performance optimization for scalable apps.",
  keywords: [
...
const seamlessCards = [
  {
    ...
    desc: "We build tailored React & Next.js interfaces aligned with your brand, business goals, and user needs—ensuring speed, scalability, and consistency.",
  },
  {
    icon: "/assets/images/icons/API-development.png",
    title: "API & Backend Integration",
    desc: "We seamlessly connect React & Next.js apps with APIs, CMSs, and backend systems for smooth data flow and real-time experiences.",
  },
  {
    icon: "/assets/images/icons/Third-party-integrations.png",
    title: "Third-Party Integrations",
    desc: "We integrate analytics, payment gateways, CRMs, and other third-party tools to enhance functionality and improve user engagement.",
  },
  {
    icon: "/assets/images/icons/Maintenance-support.png",
    title: "Performance Optimization & Support",
    desc: "We continuously optimize, monitor, and maintain your frontend to ensure fast load times, security, and long-term stability.",
  },
];
...
const whyChooseCards = [
  {
    ...
    desc: "We build fast, responsive, and interactive applications using React and Next.js, optimized for smooth UI performance, cross-device compatibility, and real-time user engagement.",
  },
  {
    icon: "/assets/images/icons/Experienced-Nodejs-Team.png",
    tag: "Proven Industry Experience",
    title: "Experienced React & Next.js Team",
    desc: "Our expert developers specialize in React component-driven development and Next.js advanced features like SSR, SSG, and API routes—ensuring clean, scalable, and maintainable code.",
  },
  {
    icon: "/assets/images/icons/Scalable-Architecture.png",
    tag: "Built for Growth",
    title: "Scalable & SEO-Friendly Architecture",
    desc: "We design modern frontend architectures that scale effortlessly. With Next.js SEO optimization and React modularity, your application stays fast, discoverable, and growth-ready.",
  },
  {
    icon: "/assets/images/icons/Secure-Backend-Solutions.png",
    tag: "Advanced Protection",
    title: "Secure & Production-Ready Solutions",
    desc: "We implement industry-standard security practices, secure authentication, optimized APIs, and reliable deployment workflows for stable, enterprise-grade React & Next.js applications.",
  },
  {
    icon: "/assets/images/icons/API-Integration-Expertise.png",
    tag: "Custom API Solutions",
    title: "API & Integration Expertise",
    desc: "From REST APIs to third-party service integrations, we connect React and Next.js applications seamlessly with backend systems, payment gateways, CRMs, and cloud services.",
  },
  {
    icon: "/assets/images/icons/Agile-Transparent-Process.png",
    tag: "Client-Centric Approach",
    title: "Agile & Transparent Process",
    desc: "We follow an agile development approach with clear communication, regular updates, and milestone-based delivery—keeping you fully informed at every stage.",
  },
  {
    icon: "/assets/images/icons/Cost-Effective-for-USA-Market.png",
    tag: "Value-Driven Pricing",
    title: "Cost-Effective for Global Market",
    desc: "Our React & Next.js development services are optimized for quality and affordability, offering cost-effective solutions tailored for USA-based startups and enterprises.",
  },
  {
    icon: "/assets/images/icons/Ongoing-Support-Maintenance.png",
    tag: "Long-Term Partnership",
    title: "Ongoing Support & Maintenance",
    desc: "Beyond development, we provide continuous support, performance optimization, feature enhancements, and maintenance to keep your application running smoothly.",
  },
];
...
const faqs = [
  ...
  {
    id: "collapseThree",
    q: "Are React & Next.js scalable?",
    a: "Yes. React and Next.js are ideal for building fast, scalable, and high-performance web applications with modern UI and optimized rendering.",
  },
  {
    id: "collapseFive",
    q: "Do you build SPAs & SEO websites?",
    a: "Absolutely. We develop SPAs, dashboards, admin panels, and SEO-friendly websites using React and Next.js.",
  },
  {
    id: "collapseelven",
...
const tags = [
  { label: "Lightning-Fast React UI", cls: "text-white gradient-bg-six" },
  { label: "Next.js SEO Boost", cls: "text-heading bg-paste" },
  { label: "SSR & SSG Power", cls: "text-heading gradient-bg-six" },
  { label: "Scalable Frontend Apps", cls: "text-heading bg-yellow" },
  { label: "Component-Driven Design", cls: "text-heading bg-orange" },
  { label: "API-Ready Frontends", cls: "text-heading gradient-bg-six" },
  { label: "Cloud-Deployed Apps", cls: "text-heading bg-orange" },
  { label: "Startup to Enterprise", cls: "text-heading gradient-bg-six" },
  { label: "Performance Optimized", cls: "text-heading bg-paste" },
          ...
          <div className="container">
            <div className="text-center">
              <span className="text-capitalize font-caveat fw-bold tw-mb-6 h3">
                Scalable React & Next.js Development{" "}
              </span>
              <div>
              ...
              <p className="splitTextStyleOne text-neutral-600 tw-text-lg tw-mt-405 tw-mt-8 max-w-672-px mx-auto fw-medium">
                We build fast, secure, and scalable React & Next.js solutions for startups and enterprises
                worldwide.
              </p>
            ...
            <div className="col-lg-7 ps-lg-5">
              <div>
                <div className="bg-neutral-100 tw-py-3 tw-px-305 rounded-pill text-heading fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max">
                  ...
                  Up to <span className="text-yellow">90%</span> Faster & SEO-Optimized Frontend Solutions
                </div>
                <h2 className="splitTextStyleOne text-heading text-capitalize">
                  ...
                  <span className="font-dm-serif fst-italic fw-normal">
                    {" "}
                    Power High-Performance, SEO-Ready{" "}
                  </span>
                  Digital Experiences
                </h2>
                <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                  We build fast, scalable, and SEO-optimized React & Next.js applications designed for modern user
                  experiences, blazing-fast load times, and business growth—helping your product convert better and
                  scale effortlessly.
                </p>
        ...
        <div className="container max-w-1400-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <p className="text-neutral-500 tw-mt-5 splitTextStyleOne max-w-500-px mx-auto">
              We craft modern React & Next.js frontends that integrate smoothly with your backend, deliver
              exceptional performance, and scale as your business grows.
            </p>
          </div>
                    ...
                    <div className="tw-mt-11 d-flex align-items-center tw-gap-42-px flex-wrap">
                      ...
                      <div>
                        <div className="d-flex align-items-center tw-gap-4">
                          ...
                          <span className="h5 counter text-white">20M+</span>
                        </div>
                ...
                <div className="text-start mx-auto tw-mb-12">
                  <div className="tw-mb-10">
                    ...
                    <h2 className="splitTextStyleOne text-heading text-capitalize max-w-532-px">
                      Fast, SEO-Friendly & Scalable React.js & Next.js Frontend Solutions
                    </h2>
                    <p className="splitTextStyleOne text-neutral-500 tw-mt-8 max-w-570-px fw-medium tw-text-lg">
                      We build high-performance React.js and Next.js applications that deliver lightning-fast load
                      times, seamless user experiences, and SEO-friendly architecture.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container max-w-1552-px">
          <div className="max-w-672-px text-center mx-auto tw-mb-12">
            ...
            <h2 className="splitTextStyleOne text-white">
              ...
              <span className="font-dm-serif fst-italic fw-normal"> With React & Next.js</span>Expertise
            </h2>
            <p className="text-neutral-300 tw-mt-5 splitTextStyleOne max-w-570-px mx-auto">
              Our React and Next.js solutions are built for speed, scalability, and exceptional user
              experience—delivering high-performance, SEO-friendly, and future-ready web applications for startups
              and enterprises.
            </p>
          </div>
          ...
          <div className="bg-green-deep tw-rounded-3xl tw-pt-100-px position-relative z-1">
            ...
            <div className="tw-mb-8 text-center max-w-570-px mx-auto">
              <div className="tw-py-3 tw-px-305 rounded-pill fw-medium text-capitalize tw-leading-none d-inline-flex align-items-center tw-gap-2 tw-mb-405 min-w-max text-white bg-white-13">
                <div>Build Fast & Scalable React & Next.js Applications</div>
              </div>
                ...
                <div className="d-flex align-items-center tw-gap-4 justify-content-center flex-wrap">
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center tw-gap-2 z-1">
                      <span className="button__label">Start Your React & Next.js Project</span>
                    </div>
                  </Link>
                  <a
                    target="_blank"
