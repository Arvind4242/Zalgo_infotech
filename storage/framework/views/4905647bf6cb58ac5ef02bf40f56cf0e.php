...
<div
    ...
    <div class="mobile-menu__inner">
        <a href="<?php echo e(route('home')); ?>" class="mobile-menu__logo">
            <img src="<?php echo e(asset('assets/images/logo/zalgo_logo.png')); ?>" alt="Logo">
        </a>
            ...
            <ul class="nav-menu d-lg-flex align-items-center nav-menu--mobile d-block tw-mt-8">
                <li class="nav-menu__item has-submenu position-relative">
                    ...
                    <ul
                        ...
                        <li class="nav-submenu__item d-block tw-rounded tw-duration-200 position-relative">
                            <a href="<?php echo e(route('culture-value')); ?>"
                                class="mega-item">
                                <div>Culture & Values</div>
                            </a>
                        </li>
                        <li class="nav-submenu__item d-block tw-rounded tw-duration-200 position-relative">
                            <a href="<?php echo e(route('life-zalgoinfotech')); ?>"
                                class="mega-item">
...
<?php /**PATH C:\zalgo-infotech\resources\views/frontend/includes/partials/navbar.blade.php ENDPATH**/ ?>