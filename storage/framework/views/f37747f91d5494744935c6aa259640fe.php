...
<style>
  ...
  @media screen and (max-width:767px){
        ...
        .arrow::before{
            content: url(<?php echo e(asset('assets/images/arrow.svg')); ?>);
        }
...
<footer class="footer bg-black position-relative z-1 mt-auto tw-pt-16 overflow-hidden">
    ...
    <div class="container">
        <div class="d-flex align-items-center tw-gap-505">
                ...
                <div
                    ...
                    <div class="max-w-514-px w-100 d-flex align-items-center tw-gap-505" data-aos="fade-up"
                        ...
                        <h3
                            ...
                            <img src="<?php echo e(asset('assets/images/icons/arrow-up-main.svg')); ?>" alt="img" />
                            88%
                        </h3>
                    ...
                    <!-- <div class="d-flex align-items-center justify-content-center tw-gap-405">
                        <div class="" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                            ...
                            <a href="https://play.google.com/store/apps" class="hover--translate-y-1 active--translate-y-scale-9">
                                <img src="<?php echo e(asset('assets/images/icons/store1.png')); ?>" alt="img" />
                            </a>
                        </div>
                        <div class="" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                            data-aos-duration="800">
                            <a href="https://www.apple.com/app-store"
                                ...
                                <img src="<?php echo e(asset('assets/images/icons/store2.png')); ?>" alt="img" />
                            </a>
                        </div>
                    </div> -->
                </div>
            ...
            <div class="flex-shrink-0 gradient-overlay d-md-block d-none">
                <img src="<?php echo e(asset('assets/images/thumbs/footer-img.png')); ?>" alt="img" />
            </div>
        </div>
    </div>
    <!-- Footer Top End -->
    ...
    <div class="footer-col text--white col-lg-3 company">
      <img src="<?php echo e(asset('assets/images/logo/zalgo-white.png')); ?>" alt="Zalgo Infotech" class="footer-logo">
      <p>
      ...
      <div class="address mb-4 mt-4">
        <p><strong><img class="me-1" width="24" src="<?php echo e(asset('assets/images/Group-4.webp')); ?>" alt="us-flag" class="site-country-flag" loading="lazy"> United States </strong></p>
      ...
      <div class="address mb-4">
        <p><strong><img class="me-1" width="24" src="<?php echo e(asset('assets/images/canada.jpg')); ?>" alt="ca-flag" class="site-country-flag" loading="lazy"> Canada</strong></p>
        ...
        <p><img width="24" src="<?php echo e(asset('assets/images/phone.svg')); ?>" alt="ca-flag" class="site-country-flag" loading="lazy"> <a class="text-white" href="tel:+16465687779">+1 (646) 568-7779</a></p>
        <p><a class="mail text-white" href="mailto:sales@zalgoinfotech.com">sales@zalgoinfotech.com</a></p>
      </div>
      <div class="address mb-4">
        <p><strong><img class="me-1" width="24" src="<?php echo e(asset('assets/images/Group-3.webp')); ?>" alt="india-flag" class="site-country-flag" loading="lazy"> India</strong></p>
    ...
    <div class="col-lg-9">
        <div class="row">
            ...
            <li>
                ...
                <li>
                    <a href="<?php echo e(asset('assets/images/case-study/zalgo-Infotech-privacy-policy.pdf')); ?>" class="mega-item" download>
                        <div class="align-items-center d-flex">
                          Privacy Policy
                        </div>
                    </a>
      ...
      <h4 class="w-100 m-0">Our Businesses</h4>
        ...
        <div class="business-card flex-column">
            <div class="business-logo">
                <img src="<?php echo e(asset('assets/images/logo/zalgo-edutech.png')); ?>" alt="">
            </div>
        ...
        <div class="business-card flex-column">
            <div class="business-logo">
                <img src="<?php echo e(asset('assets/images/logo/zalgo-store.png')); ?>" alt="">
            </div>
        ...
        <div class="business-card flex-column">
            <div class="business-logo">
                <img src="<?php echo e(asset('assets/images/logo/zalgo-india.png')); ?>" alt="">
            </div>
...
</script><?php /**PATH C:\zalgo-infotech\resources\views/frontend/includes/footers/footerOne.blade.php ENDPATH**/ ?>